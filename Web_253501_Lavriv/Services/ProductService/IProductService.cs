...
namespace WEB_253501_LAVRIV.Services.ProductService
{
    public interface IProductService
    {
        ...
        /// <returns></returns>
        public Task<ResponseData<ListModel<Detail>>> GetProductListAsync(string?
 categoryNormalizedName, int pageNo = 1);
        ...
        /// <returns></returns>
        public Task UpdateProductAsync(int id, Detail product, IFormFile? formFile);
        /// <summary>
        /// Удаление объекта
        /// </summary>
        ...
        public Task<ResponseData<Detail>> CreateProductAsync(Detail product, IFormFile?
       formFile);
    }
